...
/**
 * Client-only empty state component.
 * Handles clearing filters by pushing a URL without patientName/status and resetting page to 1.
 */
const EmptyFilterResults: React.FC<EmptyFilterResultsProps> = ({ currentFilters }) => {
